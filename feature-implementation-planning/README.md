...
**Typical workflow:**
1. `feature-acceptance-planning` → Creates acceptance criteria
2. **`feature-implementation-planning`** → Creates implementation plan (this skill)
...
```
skills/feature-implementation-planning/
...
/feature-implementation-planning .agents/acceptance/user-auth-requirements.md
```
...
**Works with:**
- `feature-acceptance-planning` - Provides input (acceptance criteria)
- `ts-best-practices` - TypeScript patterns referenced in plans
- `react-best-practices` - React patterns referenced in plans
- `ts-testing` - Testing patterns referenced in plans
