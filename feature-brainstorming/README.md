...
- **Acceptance Planning** (`feature-acceptance-planning`) - Define requirements and acceptance criteria
- **Implementation Planning** (`feature-implementation-planning`) - Create executable tasks
- **Test Planning** (`feature-test-planning`) - Define test strategy
