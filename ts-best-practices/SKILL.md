...
When users explicitly request a code correctness audit or invoke the skill directly (`/ts-best-practices <path>`), use the standardized report format:
...
- Skill invoked directly via `/ts-best-practices <path>`
