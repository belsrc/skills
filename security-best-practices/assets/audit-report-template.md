...
Completed systematic security audit of [file/module path] following security-best-practices workflow. Identified [N] security vulnerabilities across [N] OWASP categories. [Brief description of what this code does and why security matters].
