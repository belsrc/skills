...
Completed systematic audit of [file/module path] following ts-performance workflow. Identified [N] performance anti-patterns with expected gains ranging from [min]x to [max]x. [Brief description of what this code does and why performance matters].
